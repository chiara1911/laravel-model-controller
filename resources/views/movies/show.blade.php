            ...
            <div class="row">
                <div class="col-12 m-4">
                    <div class="d-flex flex-row">
                        ...
                        <div class="d-flex flex-column justify-content-around  px-4 text-uppercase opacity-75 ">
                            <h3 class="text-light"> title :{{ $movies->title }}</h3>
                            <span class="text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus saepe accusamus
                                ...
                                Voluptatum soluta deleniti error quaerat laboriosam!</span>
                                <span class="text-light">voto : {{$movies->vote}} </span>
